...
public class EmployeeServiceTest {
	...
	public void shouldInvoke_giveIncrementOfMethodOnEmployeeWhileGivingIncrement() {
		...
		// We first have to inform PowerMock that we will now verify the
		// invocation of a static method by calling verifyStatic.
	...
	public void shouldCreateNewEmployeeIfEmployeeIsNew() {
		...
		// Verifying that the create method was indeed invoked on the employee
		// instance.
		Mockito.verify(mock).create();

		// Verifying that while creating a new employee update was never
		// invoked.
	...
	public void shouldUpdateEmployeeIfEmployeeExists() {
		...
		// Verifying that the update method was indeed invoked on the employee
		// instance.
		Mockito.verify(mock).update();

		// Verifying that while updating an employee create was never invoked.
	...
	public void shouldInvokeIsNewBeforeInvokingCreate() {
		...
		// going to be important This is done by calling Mockito.inOrder and
		// passing it the mocked object.
